...
class Event():
  def __init__(self, name, location, date, url, virtual, organizerName, popularity=None, recurring=None, inPast=None, duplicate=False) -> None:
    self.name = name
  ...
  def to_markdown_string(self) -> str:
    # Returns markdown string of Event data
    if self.virtual:
